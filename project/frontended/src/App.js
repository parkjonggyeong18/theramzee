   ...
   <GameProvider>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/game/:roomId/twisted" element={<TwistedForest />} />
        <Route path="/game/:roomId/dry" element={<DryForest />} />
        <Route path="/game/:roomId/breathing" element={<BreathingForest />} />
        <Route path="/game/:roomId/foggy" element={<FoggyForest />} />
        <Route path="/game/:roomId/fairy" element={<FairyForest />} />
        <Route path="/game/:roomId/time" element={<TimeForest />} />
