...
import VineSlashGame from 'components/game/missions/VineSlashGame';
import MazeGame from 'components/game/missions/MazeGame';
      ...
      <ContentSection>
        ...
        <MissionButtons>
          <MissionButton 
            ...
            completed={completedMissions.includes('maze')}
          />
          <MissionButton 
            onClick={() => handleMissionClick('vineslash')}
            completed={completedMissions.includes('vineslash')}
          />
        ...
        {currentMiniGame === 'maze' && (
          <MiniGameOverlay>
            <MazeGame
              onComplete={() => handleMissionComplete('maze')}
              onClose={() => setCurrentMiniGame(null)}
            />
          </MiniGameOverlay>
        )}

        {currentMiniGame === 'vineslash' && (
          <MiniGameOverlay>
            <VineSlashGame
              onComplete={() => handleMissionComplete('vineslash')}
              onClose={() => setCurrentMiniGame(null)}
            />
          </MiniGameOverlay>
        )}
