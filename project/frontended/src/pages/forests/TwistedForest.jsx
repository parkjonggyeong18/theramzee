...
import SnakeGame from 'components/game/missions/SnakeGame';
import MatchingGame from 'components/game/missions/MatchingGame';
      ...
      <ContentSection>
        ...
        <MissionButtons>
          <MissionButton 
            ...
            completed={completedMissions.includes('matching')}
          />
          <MissionButton 
        ...
        {currentMiniGame === 'matching' && (
          <MiniGameOverlay>
            <MatchingGame
              onComplete={() => handleMissionComplete('matching')}
        ...
        {currentMiniGame === 'snake' && (
          <MiniGameOverlay>
            <SnakeGame
              onComplete={() => handleMissionComplete('snake')}
              onClose={() => setCurrentMiniGame(null)}
            />
          </MiniGameOverlay>
        )}
