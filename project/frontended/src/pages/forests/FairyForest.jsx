...
import FlowerGame from 'components/game/missions/FlowerGame';
import FishingGame from 'components/game/missions/FishingGame';
      ...
      <ContentSection>
        ...
        <MissionButtons>
          <MissionButton 
            ...
            completed={completedMissions.includes('fishing')}
          />
          <MissionButton 
            onClick={() => handleMissionClick('flower')}
            completed={completedMissions.includes('flower')}
          />
        ...
        {currentMiniGame === 'fishing' && (
          <MiniGameOverlay>
            <FishingGame
              onComplete={() => handleMissionComplete('fishing')}
              onClose={() => setCurrentMiniGame(null)}
            />
          </MiniGameOverlay>
        )}

        {currentMiniGame === 'flower' && (
          <MiniGameOverlay>
            <FlowerGame
              onComplete={() => handleMissionComplete('flower')}
              onClose={() => setCurrentMiniGame(null)}
            />
          </MiniGameOverlay>
        )}
...
const BackgroundImage = styled.div`
 ...
 width: 100%;
 height: 100%;
 background-image: url(${backgroundImages.fairyForest});
